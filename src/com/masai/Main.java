...
public class Main {
			...
			do {
				...
				switch (choice) {
					...
					case 1:
						...
						System.out.println("Enter the year from you want to search: ");
						int yrUpdated = sc.nextInt();
						System.out.println("Enter the month : ");
						int mtUpdated = sc.nextInt();
						System.out.println("Enter the day: ");
						int dyUpdated = sc.nextInt();
						LocalDate from = LocalDate.of(yrUpdated,mtUpdated,dyUpdated);

						System.out.println("Enter the year till you want to search: ");
						 yrUpdated = sc.nextInt();
						System.out.println("Enter the month : ");
						 mtUpdated = sc.nextInt();
						System.out.println("Enter the day : ");
						 dyUpdated = sc.nextInt();
						LocalDate to = LocalDate.of(yrUpdated,mtUpdated,dyUpdated);

						System.out.println("Enter the pSArea: ");
						String pSArea = sc.next();

						userService.totalNumberOfCrimeByPSAreaWithDateRange(pSArea, from, to, Crimes);
						break;
					...
					case 2:
						...
						System.out.println("Enter the day: ");
						dyUpdated = sc.nextInt();
						from = LocalDate.of(yrUpdated,mtUpdated,dyUpdated);
						...
						System.out.println("Enter the day : ");
						dyUpdated = sc.nextInt();
						to = LocalDate.of(yrUpdated,mtUpdated,dyUpdated);

						System.out.println("Enter the Crime type: ");
						String crimeType = sc.next();

						userService.totalNumberOfCrimeByCrimeTypeWithDateRange(crimeType, from, to, Crimes);
						break;

					case 3:
						System.out.println("Enter the criminal Name: ");
						String nameUpdated = sc.next();
						userService.searchCriminalByName(nameUpdated,Criminals);
						break;

					case 4:
						System.out.println("Enter the criminal Name: ");
						String crimeDescription = sc.next();
						userService.searchCrimeByDescription(crimeDescription, Crimes);
						break;
	...
	public static void adminLogin(Scanner sc) throws FileNotFoundException {
		...
		if (userName.equals("admin") && password.equals("admin")) {
			...
			throw new FileNotFoundException("Invalid Admin Credentials");
		}
	}
